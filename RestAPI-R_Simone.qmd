...
A **resource state** defines which actions are currently valid for a resource.  
Each state enables a specific set of operations (e.g., *New → InProgress → Completed → Closed*).
